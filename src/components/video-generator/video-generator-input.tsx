            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {showGenerationTypeSwitch && (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button type="button" className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-zinc-800 hover:bg-zinc-700 transition-colors text-sm">
                      {generationType === "video" ? (
                        <>
              ...
              <Popover open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
                ...
                <PopoverContent className="w-fit bg-zinc-900 border-zinc-800 p-4" align="start">
                  {/* Aspect Ratio */}
                  <div className="mb-4">
                    <span className="text-xs text-zinc-400 mb-2 block">{texts.aspectRatio}</span>
                  ...
                  {showDurationControl && (
                    <div className="mb-4">
                      <span className="text-xs text-zinc-400 mb-2 block">{texts.videoLength}</span>
                      <div className="flex gap-2">
                  ...
                  {showResolutionControl && (
                    <div>
                      <span className="text-xs text-zinc-400 mb-2 block">{texts.resolution}</span>
                      <div className="flex gap-2">
